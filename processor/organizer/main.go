...
import (
	...
	"voting/processor/organizer/handler"
...
type Opts struct {
	...
	APIurl  string `short:"u" long:"url" description:"REST-API endpoint to connect to" default:"http://localhost:8008"`
}
...
func main() {
	...
	handler := &handler.AdminHandler{APIurl: opts.APIurl}
